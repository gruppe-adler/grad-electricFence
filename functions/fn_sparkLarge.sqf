...
private _duration = 1 + random 0.1;
...
_spark setParticleRandom [1, [0.05, 0.05, 0.1], [0.5, 0.5, -0.2], 0, 0.0025, [0, 0, 0, 0], 0, 0];
...
/*
private _sparks = "#particlesource" createVehicle _position;
_sparks setPos _position;
_sparks setParticleClass "AvionicsSparks";


private _sparkSounds = selectRandom ["A3\Sounds_F\sfx\special_sfx\sparkles_wreck_1.wss","A3\Sounds_F\sfx\special_sfx\sparkles_wreck_5.wss"];

playSound3D [_sparkSounds, objNull, false, _position, 5, 1 + random (0.2) - random (0.4), 5];
